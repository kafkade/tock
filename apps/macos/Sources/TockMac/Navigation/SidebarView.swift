...
/// macOS sidebar — three-column NavigationSplitView sidebar.
///
/// Shows smart views (Today, Inbox, Upcoming, Anytime, Someday, Logbook),
/// projects, areas, and utility sections (Habits, Timer).
/// Settings are accessed via the macOS Settings scene (⌘,), not the sidebar.
